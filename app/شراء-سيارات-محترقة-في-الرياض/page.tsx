...
import { Phone, MessageCircle, Car, Flame } from "lucide-react"
import { Button } from "@/components/ui/button"
import Link from "next/link"

export default function BuyBurntCarsRiyadh() {
    ...
    <div className="flex min-h-screen flex-col bg-white">
          ...
          <div className="absolute inset-0 z-0">
            {isClient && (
              <Image
                ...
                alt="شراء سيارات محترقة في الرياض"
                fill
                sizes="100vw"
          ...
          <div className="container relative z-10 py-12 md:py-24 text-white">
            <div className="max-w-3xl space-y-4 text-right">
              <div className="inline-block bg-secondary/90 px-3 py-2 md:px-4 md:py-2 rounded-lg mb-2">
                <h1 className="text-2xl md:text-5xl font-bold">شراء سيارات محترقة في الرياض</h1>
              </div>
              <p className="text-base md:text-xl opacity-90">
                نشتري السيارات المحترقة بأفضل الأسعار مع خدمة سحب مجانية في جميع أنحاء الرياض
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12">
          <div className="container">
            <div className="max-w-4xl mx-auto text-right">
              <h2 className="text-3xl font-bold text-primary mb-6">شراء سيارات محترقة في الرياض</h2>

              <p className="mb-4">
                هل تعرضت سيارتك للحريق؟ هل تبحث عن طريقة للتخلص منها والحصول على أفضل سعر؟ نحن متخصصون في{" "}
                <strong>شراء سيارات محترقة في الرياض</strong> بأعلى الأسعار وبطريقة سهلة وسريعة.
              </p>

              <p className="mb-4">
                نشتري جميع أنواع السيارات المحترقة مهما كان حجم الضرر. سواء كانت السيارة متضررة بشكل بسيط أو كبير من
                الحريق، نحن نقدم لك أفضل سعر ممكن مع خدمة سحب مجانية من موقعك في الرياض.
              </p>

              <div className="bg-primary/5 p-6 rounded-xl mb-6">
                <h3 className="text-xl font-bold mb-3">مميزات خدمتنا لشراء السيارات المحترقة</h3>
                <ul className="list-disc mr-6 space-y-2">
                  <li>تقييم مجاني وعادل للسيارة المحترقة</li>
                  ...
                  <li>فريق فني متخصص في تقييم السيارات المحترقة</li>
                </ul>
              </div>

              <h3 className="text-2xl font-bold text-primary mb-4">أنواع السيارات المحترقة التي نشتريها</h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-2">
                    {isClient && <Flame className="h-6 w-6 text-primary flex-shrink-0 mt-1" />}
                    <h4 className="font-bold">سيارات محترقة جزئياً</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    نشتري السيارات التي تعرضت لحريق جزئي وتضررت بعض أجزائها فقط.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-2">
                    {isClient && <Flame className="h-6 w-6 text-primary flex-shrink-0 mt-1" />}
                    <h4 className="font-bold">سيارات محترقة كلياً</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    نشتري السيارات التي تعرضت لحريق كامل وتضررت بشكل كبير.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-2">
                    {isClient && <Flame className="h-6 w-6 text-primary flex-shrink-0 mt-1" />}
                    <h4 className="font-bold">سيارات محترقة المحرك</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    نشتري السيارات التي تعرض محركها للحريق وتضرر بشكل كبير.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-2">
                    {isClient && <Flame className="h-6 w-6 text-primary flex-shrink-0 mt-1" />}
                    <h4 className="font-bold">سيارات محترقة الكابينة</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">نشتري السيارات التي تعرضت كابينتها الداخلية للحريق.</p>
                </div>

                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-2">
                    {isClient && <Flame className="h-6 w-6 text-primary flex-shrink-0 mt-1" />}
                    <h4 className="font-bold">سيارات محترقة نتيجة حادث</h4>
                  </div>
                  <p className="text-sm text-muted-foreground">نشتري السيارات التي تعرضت للحريق نتيجة حادث مروري.</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-sm text-muted-foreground">
                    نشتري جميع ماركات وموديلات السيارات المحترقة: تويوتا، نيسان، هيونداي، كيا، فورد، وغيرها.
                  </p>
                </div>
              </div>

              <h3 className="text-2xl font-bold text-primary mb-4">كيف تبيع سيارتك المحترقة في الرياض؟</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg shadow-md text-center">
                  ...
                  <p className="text-sm">اتصل بنا أو أرسل رسالة عبر الواتساب مع وصف وصور للسيارة المحترقة</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md text-center">
                  <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center mx-auto mb-3">
                    2
                  ...
                  <p className="text-sm">نقوم بتقييم سيارتك المحترقة وتقديم عرض سعر مناسب</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md text-center">
                  <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center mx-auto mb-3">
                    3
              ...
              <div className="bg-secondary/10 p-6 rounded-xl mb-6">
                ...
                <p className="mb-4">لا تتردد في التواصل معنا لبيع سيارتك المحترقة والحصول على أفضل سعر في الرياض.</p>
      ...
      <footer className="py-6 bg-slate-900 text-white">
        <div className="container text-center">
          <p>© {new Date().getFullYear()} شريطي سيارات - شراء سيارات محترقة في الرياض - جميع الحقوق محفوظة</p>
          <div className="mt-2">
            <a
